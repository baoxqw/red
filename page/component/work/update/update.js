...
Page({
  ...
  onLoad: function (options) {
    ...
    that.setData({
      list: formData,
      dates: formData.batchtime.substring(0, 10),
      id: formData.id,
      manage: formData.pickbatchName,
      manageid: formData.pickbatchid
    })
    // 采摘批次名称数据
    wx.request({
      ...
      success: function (res) {
        ...
        that.setData({ workarray: chemicalCategArray })
